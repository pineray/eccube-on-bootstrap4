    ...
    <body class="<!--{$tpl_page_class_name|h}-->">
        ...
        <div class="frame_outer">
            ...
            <div id="container" class="container clearfix">
                ...
                <div class="row <!--{if $tpl_column_num == 1}-->justify-content-center<!--{/if}-->">

                    <!--{* ▼CENTER COLUMN *}-->
                    <div id="main_column" class="mb-4 mb-md-0 col-12 <!--{if $tpl_column_num == 3}-->
                            col-md-6
                    ...
                    <!--{if !empty($arrPageLayout.LeftNavi)}-->
                        <div id="leftcolumn" class="side_column col-12<!--{if $tpl_column_num == 3}--> col-sm-6<!--{/if}--> col-md-3 order-md-first">
                            <!--{* ▼左ナビ *}-->
                    ...
                    <!--{if !empty($arrPageLayout.RightNavi)}-->
                        <div id="rightcolumn" class="side_column col-12<!--{if $tpl_column_num == 3}--> col-sm-6<!--{/if}--> col-md-3 order-last">
                            <!--{* ▼右ナビ *}-->
