...
<!--{strip}-->
    ...
    <dt class="col12 col-sm-3">FAX</dt>
    <dd class="col12 col-sm-9">
    ...
    <!--{if $flgFields > 1}-->
        ...
        <!--{if $emailMobile}-->
            <dt class="col12 col-sm-3">携帯メールアドレス</dt>
            <dd class="col12 col-sm-9">
        ...
        <!--{if $flgFields > 2}-->
            <dt class="col12 col-sm-3">希望するパスワード</dt>
            <dd class="col12 col-sm-9"><!--{$passlen}--></dd>
            <dt class="col12 col-sm-3">パスワードを忘れた時のヒント</dt>
            <dd class="col12 col-sm-9">
            ...
            <dt class="col12 col-sm-3">メールマガジン送付について</dt>
            <dd class="col12 col-sm-9">
