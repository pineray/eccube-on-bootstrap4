    ...
    <div class="form-group row">
        ...
        <div class="col">
            <div class="form-row no-gutter<!--{if $arrErr[$key1] || $arrErr[$key2]}--> is-invalid<!--{/if}-->">
                <div class="col">
                    <input type="text" id="<!--{$key1}-->" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="ime-mode: disabled;" class="box60 form-control<!--{if $arrErr[$key1]}--> is-invalid<!--{/if}-->" />
                </div>
                <label class="col-auto">-</label>
                <div class="col">
                    <input type="text" id="<!--{$key2}-->" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$arrForm[$key2].length}-->" style="ime-mode: disabled;" class="box60 form-control<!--{if $arrErr[$key2]}--> is-invalid<!--{/if}-->" />
                </div>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="form-row<!--{if $arrErr[$key1] || $arrErr[$key2] || $arrErr[$key3]}--> is-invalid<!--{/if}-->">
                    ...
                    <div class="col col-auto">-</div>
                    <div class="col">
                        <input type="text" id="<!--{$key3}-->" name="<!--{$key3}-->" value="<!--{$arrForm[$key3].value|h}-->" maxlength="<!--{$arrForm[$key3].length}-->" style="ime-mode: disabled;" class="box60 form-control<!--{if $arrErr[$key3]}--> is-invalid<!--{/if}-->" />
                    </div>
                </div>
